...
public class EigenvaluesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner spinnerDim = (Spinner) findViewById(R.id.spinner_eigenvalues);
        Button btn_calc = (Button) findViewById(R.id.calc_eigenvalues);
        final TextView result = (TextView) findViewById(R.id.textView_eigenvalues_result);
        ...
        btn_calc.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                GridView grid_eigenvalues = (GridView)findViewById(R.id.grid_eigenvalues);
                ...
                // System.out eigenvalues in the form of Lambda = re(Lambda) + im(Lambda)*i
                for(int i = 0; i < realPart.length; i++) {
                    System.out.println("Eigen Value " + i + " = " +
                            df.format(realPart[i]) + " + " +
                            df.format(imagPart[i]) + "i");
                }

                // Set text to show result
                result.setText("");
                for(int i = 0; i < realPart.length; i++){
                    result.append("Eigen Value " + i + " = " +
                            df.format(realPart[i]) + " + " +
                            df.format(imagPart[i]) + "i\n");
                }
            }
    ...
    private void setMatrix() {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                GridView grid = (GridView)findViewById(R.id.grid_eigenvalues);
